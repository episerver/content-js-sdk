...
[CMS-55279](https://optimizely-ext.atlassian.net/browse/CMS-55279): Forms placed in a content area now render their fields. Their steps are fetched automatically, so `content.nodes` is populated wherever the form sits.
