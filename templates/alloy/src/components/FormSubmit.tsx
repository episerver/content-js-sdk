...
export default function FormSubmit({ content }: FormSubmitProps) {
  return (
    <button
      ...
      className='px-6 py-3 rounded-lg bg-slate-700 text-white font-medium hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-700 focus:ring-offset-2 w-fit'
    >
