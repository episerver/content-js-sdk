...
export interface components {
  schemas: {
    ...
    ComponentListItem: Omit<
      components['schemas']['ListPropertyItem'],
      'type'
    > & {
      contentType: string;
    } & {
    ...
    ContentType: {
      ...
      properties?: {
        [key: string]: {
          ...
          | components['schemas']['BinaryProperty']
          | components['schemas']['BooleanProperty']
          | components['schemas']['ComponentProperty']
          | components['schemas']['ContentProperty']
          | components['schemas']['ContentReferenceProperty']
          | components['schemas']['DateTimeProperty']
          | components['schemas']['FloatProperty']
          | components['schemas']['IntegerProperty']
          | components['schemas']['StringProperty']
          | components['schemas']['UrlProperty']
          | components['schemas']['JsonStringProperty']
    ...
    ListProperty: Omit<components['schemas']['ContentTypeProperty'], 'type'> & {
      ...
      items:
        | components['schemas']['ComponentListItem']
        | components['schemas']['ContentListItem']
        | components['schemas']['ContentReferenceListItem']
        | components['schemas']['DateTimeListItem']
        | components['schemas']['FloatListItem']
        | components['schemas']['IntegerListItem']
        | components['schemas']['StringListItem']
        | components['schemas']['UrlListItem'];
    } & {
      /**
       * @description discriminator enum property added by openapi-typescript
       * @enum {string}
    ...
    UrlListItem: Omit<components['schemas']['ListPropertyItem'], 'type'> &
      Record<string, never> & {
        /**
         * @description discriminator enum property added by openapi-typescript
         * @enum {string}
    ...
    UrlProperty: Omit<components['schemas']['ContentTypeProperty'], 'type'> &
      Record<string, never> & {
        /**
         * @description discriminator enum property added by openapi-typescript
         * @enum {string}
