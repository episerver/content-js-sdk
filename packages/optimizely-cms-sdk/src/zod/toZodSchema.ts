...
const experienceCompositionNodeSchema: z.ZodTypeAny = z.object({
  __typename: z.string(),
...
const experienceNodeSchema: z.ZodTypeAny = z.lazy(() =>
...
const experienceStructureNodeSchema: z.ZodTypeAny = z.lazy(() =>
  experienceCompositionNodeSchema.and(z.object({
    nodeType: z.string(),
    nodes: z.array(experienceNodeSchema).optional(),
  }).passthrough()),
...
function buildStringSchema(property: StringProperty): z.ZodTypeAny {
...
function buildIntegerSchema(property: IntegerProperty): z.ZodTypeAny {
...
function buildFloatSchema(property: FloatProperty): z.ZodTypeAny {
  let schema = z.number();
  if (property.minimum !== undefined) schema = schema.min(property.minimum);
  if (property.maximum !== undefined) schema = schema.max(property.maximum);
...
function buildArraySchema(property: ArrayProperty<ArrayItems>, visited: Set<string>): z.ZodTypeAny {
...
function propertyToZodSchema(property: AnyProperty, visited: Set<string>): z.ZodTypeAny {
