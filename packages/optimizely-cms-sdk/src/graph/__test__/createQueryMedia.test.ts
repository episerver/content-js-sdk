  ...
  test('should not create extra fragments when referred explicitly', async () => {
    ...
    expect(result.fragments).toMatchInlineSnapshot(`
      [
        ...
        "fragment ctImage on ctImage { __typename ctImage__p1:p1 ..._IContent ...AssetMetadata ...ImageMetadata }",
        "fragment ctVideo on ctVideo { __typename ctVideo__p1:p1 ..._IContent ...AssetMetadata }",
        "fragment ctMedia on ctMedia { __typename ctMedia__p1:p1 ..._IContent ...AssetMetadata }",
  ...
  test('should create base types when referred by base type', async () => {
    ...
    expect(result.fragments).toMatchInlineSnapshot(`
      [
        ...
        "fragment ImageMetadata on _ImageItem { _imageMetadata { width height } }",
        "fragment ctImage on ctImage { __typename ctImage__p1:p1 ..._IContent ...AssetMetadata ...ImageMetadata }",
        "fragment _image on _Image { __typename ..._IContent ...AssetMetadata ...ImageMetadata }",
        "fragment ctVideo on ctVideo { __typename ctVideo__p1:p1 ..._IContent ...AssetMetadata }",
        "fragment _video on _Video { __typename ..._IContent ...AssetMetadata }",
        "fragment ctMedia on ctMedia { __typename ctMedia__p1:p1 ..._IContent ...AssetMetadata }",
        "fragment _media on _Media { __typename ..._IContent ...AssetMetadata }",
