...
/** Options for Graph */
export type GraphOptions = Omit<GraphConfig, 'key'>;
 ...
 * @internal This is called automatically when configureGraph is called
 */
 ...
 * import { configureGraph } from '@optimizely/cms-sdk';
 *
 * configureGraph({
